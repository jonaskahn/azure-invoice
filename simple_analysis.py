...
class SimpleInvoiceData:
    ...
    def get_data_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'unique_subscriptions': self.df[
                'SubscriptionName'].nunique() if 'SubscriptionName' in self.df.columns else 0
        }
...
class SimpleDashboard:
    ...
    def run_simple_analysis(self, data: SimpleInvoiceData):
        ...
        with st.container():
            ...
            st.success(
                "✅ Simple analysis complete! Service costs, regional distribution, and efficiency metrics calculated.")
